  ...
  return (
    <>
      <div className='w-full h-full'>
        <div className='w-full h-[18%] px-8 py-10 bg-green-300 flex items-center justify-between'>
        ...
        <form action="" method="post" className='h-[75%] flex flex-col items-center justify-center'>
          <input className='mb-5 px-5 py-3 outline-none bg-transparent text-white text-base border-2 border-zinc-500 rounded-md w-1/4' type="text" placeholder='Enter Username'/>
          ...
          <input className=' px-5 py-3 outline-none bg-green-300 text-base rounded-md' type="Submit" value="Submit" />
        </form>
